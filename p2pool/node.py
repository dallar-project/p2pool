        ...
        def handle_header(new_header, valid=False):
            ...
            if (self.best_block_header.value is None
                or (
                    ...
                    bitcoin_data.hash_throestl(bitcoin_data.block_header_type.pack(self.best_block_header.value)) == bitcoind_best_block
                ) # new is child of current and previous is current
                or (
                    bitcoin_data.hash_throestl(bitcoin_data.block_header_type.pack(new_header)) == bitcoind_best_block and
